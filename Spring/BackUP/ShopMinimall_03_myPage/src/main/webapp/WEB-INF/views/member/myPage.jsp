...
<input type="hidden" value="${login.userid }" na0me="userid">
*아이디: ${login.userid }<br>
*비밀번호 확인 : <input id="passwd" type="password" value="" name="passwd"><br>
...
전화번호:<select name="phone1">
  <option value="017" <c:if test="${login.phone1=='017' }">selected</c:if>>017</option>
