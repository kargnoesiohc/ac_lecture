...
public class SendMailServlet_stu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String from = "csr961120@naver.com"; //보내는 메일
	    ...
	    try{
	     ...
	     Authenticator auth = new SendMail_stu();
	     ...
	     session.setAttribute("str", "입력하신 이메일로 아이디를 전송하였습니다.");
